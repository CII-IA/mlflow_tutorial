...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        if tracking_url_type_store != "file":
            ...
            # We should generate a requirementes.txt with python -m pip freeze > requirements.txt
            #mlflow.sklearn.log_model(lr, "model", pip_requirements="requirements.txt")
